...
function PaymentScreen({ methods, selectedId, onSelect, onBack, onContinue, onAddCard, onDelete }: any) {
  return (
    <View style={styles.container}>
      <View style={styles.headerBar}>
        <TouchableOpacity style={styles.headerBackButton} onPress={onBack}><Text style={styles.headerBackText}>←</Text></TouchableOpacity>
...
function SummaryScreen({ cartDetails, total, address, payment, onBack, onSubmit, onPressLegal }: any) {
  return (
    <View style={styles.container}>
      <View style={styles.headerBar}>
        <TouchableOpacity style={styles.headerBackButton} onPress={onBack}><Text style={styles.headerBackText}>←</Text></TouchableOpacity>
